...
class MemoryUI:
    ...
    #     """Display the main menu UI header"""
    #     connection_status = "✓ Connected" if self.connected else "✗ Disconnected"
    #     print("\n" + "="*50)
    #     print("      MEMORY MANAGEMENT SYSTEM")
    #     print("="*50)
    #     print(f"Active Scope -> User ID: {self.user_id} | Agent ID: {self.agent_id}")
    #     print(f"Status: {connection_status}")
    #     print("-"*50)
    #     print("1.  Add Memory")
    #     print("2.  Get All Memories (For Active Agent)")
    #     print("3.  Get Specific Memory by ID")
    #     print("4.  Update Memory")
    #     print("5.  Delete Specific Memory")
    #     print("6.  Delete All Memories (For Active Agent)")
    #     print("7.  Search Memories")
    #     print("8.  Get Memory History")
    #     print("9.  Reset System Memories (Wipe All)")
    #     print("10. Change Active Agent / User ID")
    #     print("0.  Exit")
    #     print("-"*50)
    ...
    def run(self):
        ...
        # menu_options = {
        #     "1": self.add_memory,
        #     "2": self.get_all_memories,
        #     "3": self.get_memory,
        #     "4": self.update_memory,
        #     "5": self.delete_memory,
        #     "6": self.delete_all_memories,
        #     "7": self.search_memories,
        #     "8": self.get_memory_history,
        #     "9": self.reset_all_memories,
        #     "10": self.set_user_and_agent_id,
        # }
...
if __name__ == "__main__":
    # Prompt user for agent identifier at boot
    # agent_id_input = input("Enter Agent ID to manage (e.g. support_agent): ").strip() or "default_agent"
    # user_id_input = input("Enter User ID [default_user]: ").strip() or "default_user"
    
    ui = MemoryUI(agent_id="transcript_agent")
    ui.run()